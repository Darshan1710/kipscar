...
*
*  Demo JS code for components_notifications_other.html page
*
* ---------------------------------------------------------------------------- */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#noty_confirm').on('click', function() {
        var notyConfirm = new Noty({
            text: '<h6 class="content-group">Please confirm your action</h6><label>Enter comment (optional)</label> <input type="text" class="form-control" placeholder="Enter comment">',
            timeout: false,
            modal: true,
            layout: 'center',
            closeWith: 'button',
            ...
            buttons: [
                ...
                Noty.button('Submit <i class="icon-paperplane position-right"></i>', 'btn bg-blue position-right', function () {
                        alert('Submitted!');
                        notyConfirm.close();
                    },
