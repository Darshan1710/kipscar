...
*  # Single navbar
*
*  Demo JS code for navbar_single.html page
*
* ---------------------------------------------------------------------------- */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toggleType.onchange = function() {
        if(toggleType.checked) {
            ...
            $('body').find('.navbar').first().addClass('navbar-fixed-top');
            ...
            // Toggle necessary body and navbar classes
            $('body').find('.navbar').first().removeClass('navbar-fixed-top');
    ...
    togglePosition.onchange = function() {
        if(togglePosition.checked) {
            ...
            // Toggle necessary body and navbar classes
            $('body').find('.navbar').first().addClass('navbar-fixed-bottom');
            ...
            // Toggle necessary body and navbar classes
            $('body').find('.navbar').first().removeClass('navbar-fixed-bottom');
