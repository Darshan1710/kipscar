...
*
*  Demo JS code for components_loaders.html page
*
* ---------------------------------------------------------------------------- */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Start
    $('#h-center-basic-start').on('click', function() {
    ...
    // Start
    $('#h-center-nonpercentage-basic-start').on('click', function() {
    ...
    // Start
    $('#v-center-basic-start').on('click', function() {
    ...
    // Reset
    $('#v-center-basic-reset').on('click', function() {
    ...
    // Start
    $('#v-center-nonpercentage-basic-start').on('click', function() {
    ...
    // Reset
    $('#v-center-nonpercentage-basic-reset').on('click', function() {
