                ...
                <div class="page-header page-header-default">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#.html">Condition</a></li>
                            <li class="active">Condition List</li>
                        </ul>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Condition</a>
                        </div>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete" data-url="<?php echo base_url()?>Condition/deleteCondition/<?php echo $row['id']?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Condition form</h5>
            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <input type="text" placeholder="Condition" class="form-control" name="condition" id="condition">
                                </div>
                            <div class="col-sm-6">
                                    <label>Status</label>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Condition</label>
                                <input type="text" placeholder="Condition" class="form-control condition" name="condition" >
                            </div>
                                <div class="col-sm-6">
                                    <label>Status</label>
...
<script type="text/javascript">
        ...
        $('#add').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Condition/addCondition',
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                url: base_url + 'Condition/editCondition',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {

                        $('.id').val(id);
                        $('.condition').val(obj.data.condition);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Condition/updateCondition',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
