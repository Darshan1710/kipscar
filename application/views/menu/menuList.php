                           ...
                           <div class="card">
                              <div class="card-header">
                                 <div class="row">
                                      ...
                                      <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#add_modal" style="margin-right: 1%;"><i class="icon-user" aria-hidden="true"></i> Add Menu</a>

                                    
                                 </div>
                                 
                              </div>
                              <table class="table datatable-basic table-hover text-center" id="menuList">
                                 <thead>
                                    <tr>
                                       <th>Sr. No.</th>
                                       <th>Menu</th>
                                            ...
                                            <td><div class="list-icons">
                                             <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                   <a href="#" data-toggle="modal" data-target="#edit_modal" class="dropdown-item editMenu" id="<?php echo $row['id']?>"><i class="icon-file-pencil"></i>Edit</a>
                                                </div>
                                             </div>
                                          </div></td>
                                          </tr>
    ...
    <div class="modal-sm modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center">Add Menu</h5>
                    ...
                    <div class="form-group">
                        <div class="row">
                              <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Menu</label>
                                    <input class="form-control" type="text" name="menu" id="menu" placeholder="Enter menu">
                                </div>
                              </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                              <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Menu</label>
                                    <input class="form-control menu" name="menu"  placeholder="Enter menu">
                                </div>
                              </div>
                        </div>
                    </div>
