                        ...
                        <table class="table" id="customer-report">
                            ...
                            <tbody>
                                <?php if(isset($customer_report)) {
                                    $i = 1;
                                      foreach($customer_report as $row){
                                ...
                                ?>
                                    ...
                                    <td><a href="<?php echo base_url() ?>Customer/customerOrderList/<?php echo $row['customer_unique_id'] ?>"><?php echo $row['number_of_orders']; ?></a></td>
