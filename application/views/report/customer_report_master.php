            ...
            <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#.html">Delivery Person</a></li>
                            <li class="active">Delivery Person List</li>
                        </ul>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <table class="table" id="customer-report">
                            <thead>
                                <tr>
                                    <th>Sr. No.</th>
                                    <th>Total</th>
                            ...
                            <tbody>
                                <?php if(isset($customer_report_master)) {
                                    $i = 1;
                                      foreach($customer_report_master as $row){
                                      
                                ?>
                                    <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><a href="<?php echo base_url() ?>Customer/viewOrderDetails/<?php echo $row['order_id'] ?>"><?php echo $row['subtotal']; ?></a></td>
...
<script type="text/javascript">
    var table = $('#customer-report').DataTable({
