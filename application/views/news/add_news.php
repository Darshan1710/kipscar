                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-3">
                                <label>Title</label>
                                <input type="text" placeholder="Title" class="form-control" name="title" value="<?php echo set_value('title')?>" id="title">
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea name="description" class="form-control" id="description" rows="10"><?php echo set_value('description')?></textarea>
                            </div>
                        </div>
                    </div>
