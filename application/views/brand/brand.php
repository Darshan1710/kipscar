                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Brand</a>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url() ?>Brand/viewBrand"><i class="icon-home4"></i> Reorder Brand</a>
                        </div>
                        ...
                        <table class="table" id="table_list">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td><img src="<?php echo $image =  !empty($row['image']) ? base_url().$row['image'] : 'https://thumbs.dreamstime.com/b/no-image-available-icon-photo-camera-flat-vector-illustration-132483141.jpg'; ?>" width="50px" height="50px"></td>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" id="<?php echo $row['id'] ?>" data-toggle="modal" data-target="#edit_modal" class="editBrand"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete" data-url="<?php echo base_url()?>Brand/deleteBrand/<?php echo $row['id']?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" placeholder="Brand Name" class="form-control" name="brand" id="brand">
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Brand Name</label>
                                <input type="text" placeholder="Brand Name" class="form-control brand" name="brand" >
                            </div>
                            <div class="col-sm-6">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.editBrand', function() {
            ...
            $.ajax({
                ...
                url: base_url + 'Brand/editBrand',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('.id').val(id);
                        $('.brand').val(obj.data.brand);
