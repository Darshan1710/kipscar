...
<!-- 2 columns form -->
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <a href="javascript:void(0);" class="btn btn-s-sm btn-danger btn-rounded pull-right reorder_link" id="saveReorder">Reorder Brand</a>
                        ...
                        ?>
                            <li id="image_li_<?php echo $row['id']; ?>" class="ui-sortable-handle col-md-3">
                                <a href="javascript:void(0);" style="float:none;" class="image_link">
                                    <img src="<?php echo $src = isset($row['image']) && !empty($row['image']) ? base_url($row['image']) : 'https://thumbs.dreamstime.com/b/no-image-available-icon-photo-camera-flat-vector-illustration-132483141.jpg'; ?>" width="150px" height="150px" class="center-block"/>
                                </a>
                                <p class="text-center"><?php echo $row['brand']?></p>
                            </li>
    ...
    $('.reorder_link').on('click',function(){
        ...
        $("#saveReorder").click(function( e ){
            if( !$("#saveReorder i").length ){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Brand/orderUpdate'); ?>",
                    data: {ids: " " + h + ""},
                    success: function(){
