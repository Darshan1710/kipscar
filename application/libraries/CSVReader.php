        ...
        while(($row = fgetcsv($csvFile, $this->max_row_size, $this->separator, $this->enclosure)) !== FALSE){
            ...
            if($row != NULL){
                ...
                if(count($keys) == count($values)){
                    ...
                    $errorArr        = array();
                    $err_values = array();
                    $err_values = $this->escape_string($values);
                    $errorArr[$keys[0]] = $values[0];
                    $errorArr['error'] = 'Column and Data is mismatch because of special charchters';
